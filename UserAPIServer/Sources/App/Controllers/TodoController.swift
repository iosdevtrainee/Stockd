...
final class TodoController {
    ...
    func delete(_ req: Request) throws -> Future<HTTPStatus> {
        ...
        // only a unique id would let the Todo.self work correctly
        // we make sure the todo is the users, once we've confirmed
        // we delete the todo object and update the model
